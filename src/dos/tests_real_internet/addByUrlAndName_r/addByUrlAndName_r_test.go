...
https://raw.githubusercontent.com/steenhansen/go-podcast-downloader/main/src/dos/tests_real_internet/AddByUrlAndName/git-server-source/add-by-url-and-name.rss
