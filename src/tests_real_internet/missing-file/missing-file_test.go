...
const expectedBads = `	
E_10 : HTTP error 404 Not Found : https://raw.githubusercontent.com/steenhansen/pod-down-consol/main/src/internet-tests/missing-file/git-server-source/no-such-file.txt
`
